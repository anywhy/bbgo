...
type Order struct {
	...
	// OriginalOrderId is the order id of the executed normal order on exchange for algo order
	OriginalOrderId uint64 `json:"originalOrderId,omitempty" db:"original_order_id"`
